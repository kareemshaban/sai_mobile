...
class RegisterVerificationUseCase
    extends BaseUseCase<AuthParams, RegisterEntity> {
  final AuthRepository _authRepository;
  RegisterVerificationUseCase(this._authRepository);

  @override
  Future<Either<Failure, RegisterEntity>> execute(AuthParams params) async {
    return await _authRepository.registerVerification(params);
  }
}
