...
class UpdateUserRoleUseCase extends BaseUseCase<UpdateRoleParams, dynamic> {
  final RoomRepository _roomRepository;
  UpdateUserRoleUseCase(this._roomRepository);

  @override
  Future<Either<Failure, dynamic>> execute(UpdateRoleParams params) async {
    return await _roomRepository.updateUserRole(params);
  }
}
