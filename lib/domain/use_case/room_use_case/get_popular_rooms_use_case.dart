...
class GetPopularRoomsUseCase extends BaseUseCase<int, RoomPaginationEntity> {
  final RoomRepository _roomRepository;
  GetPopularRoomsUseCase(this._roomRepository);

  @override
  Future<Either<Failure, RoomPaginationEntity>> execute(int params) async {
    return await _roomRepository.getPopularRooms(params);
  }
}
