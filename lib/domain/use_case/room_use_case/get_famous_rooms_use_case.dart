...
class GetFamousRoomsUseCase extends BaseUseCase<int, RoomPaginationEntity> {
  final RoomRepository _roomRepository;
  GetFamousRoomsUseCase(this._roomRepository);

  @override
  Future<Either<Failure, RoomPaginationEntity>> execute(int params) async {
    return await _roomRepository.getFamousRooms(params);
  }
}
