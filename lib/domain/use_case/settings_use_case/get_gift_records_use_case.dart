...
class GetGiftRecordsUseCase extends BaseUseCase<int, RecordPaginationEntity> {
  final WalletRepository _walletRepository;
  GetGiftRecordsUseCase(this._walletRepository);

  @override
  Future<Either<Failure, RecordPaginationEntity>> execute(int params) async {
    return await _walletRepository.getGiftRecords(params);
  }
}
