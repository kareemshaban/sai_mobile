...
class ChangeEmailUseCase extends BaseUseCase<ChangeEmailPhoneParams, dynamic> {
  final SettingsRepository _settingsRepository;
  ChangeEmailUseCase(this._settingsRepository);

  @override
  Future<Either<Failure, dynamic>> execute(
      ChangeEmailPhoneParams params) async {
    return await _settingsRepository.changeEmail(params);
  }
}
