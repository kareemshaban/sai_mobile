...
class ChangePhoneUseCase extends BaseUseCase<ChangeEmailPhoneParams, dynamic> {
  final SettingsRepository _settingsRepository;
  ChangePhoneUseCase(this._settingsRepository);

  @override
  Future<Either<Failure, dynamic>> execute(
      ChangeEmailPhoneParams params) async {
    return await _settingsRepository.changePhone(params);
  }
}
