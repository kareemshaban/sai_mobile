...
class Android {
  ...
  Future<String> shareTextToPackages(String text, String packageName) {
    return AppinioSocialSharePlatform.instance
        .shareTextToPackage(text, packageName);
  }

  Future<String> shareFilesToPackage(
      List<String> filePaths, String packageName) {
    return AppinioSocialSharePlatform.instance
        .shareFilesToPackage(filePaths, packageName);
  }
}
