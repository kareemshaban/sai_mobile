...
class MethodChannelAppinioSocialShare extends AppinioSocialSharePlatform {
  ...
  final String textToPackage = "text_to_package";
  final String filesToPackage = "files_to_package";
  ...
  @override
  Future<String> shareTextToPackage(String messages, String packageName) async {
    return ((await methodChannel.invokeMethod<String>(textToPackage,
            {"packageName": packageName, "message": messages})) ??
        "");
  }

  @override
  Future<String> shareFilesToPackage(
      List<String> filePaths, String packageName) async {
    return ((await methodChannel.invokeMethod<String>(filesToPackage,
            {"packageName": packageName, "imagePaths": filePaths})) ??
        "");
  }
}
