...
public class AppinioSocialSharePlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    private final String FILES_TO_PACKAGE = "files_to_package" ;
        private final String TEXT_TO_PACKAGE = "text_to_package" ;
    ...
    public String decideApp(@NonNull MethodCall call, @NonNull Result result) {
        ...
        switch (call.method) {
            ...
            case SMS_ANDROID_MULTIFILES:
                ...
                case FILES_TO_PACKAGE:
                    return socialShareUtil.shareFilesToPackage(imagePaths, activeContext,packageName);
                             case TEXT_TO_PACKAGE:
                    return socialShareUtil.shareTextToPackage(message, activeContext,packageName);
            default:
                return null;
        }
    }
